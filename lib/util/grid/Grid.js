...
define(["jquery","Util","css!util/grid/Grid.css","css!modules/Font-Awesome/css/font-awesome.min.css"],function($,Util){
    ...
    Grid.prototype.render = function(){
        ...
        //操作栏
        this.config.toolbar && gridPanel.append(createToolbar(this));
        //表格表头、表格数据
        this.pageInfo = getRealDataAdapter(this);
        var table = $('<table class="table table-hover"></table>').append(createHeadRow(this.config)).append(createDataRows(this));
        $('<div></div>').append(table).appendTo(gridPanel);
        //分页,大于一页才渲染
